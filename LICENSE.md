Pelo fato do criador original ter decidido por ter uma licença própria e deste projeto ser apenas um fork (no caso, uma breve modificação) do sistema atual, segue abaixo o texto original da mesma:
